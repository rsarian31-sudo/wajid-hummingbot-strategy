...
def test_bullish_sweep_mss():
    ...
    # The final row is treated as the currently-forming candle.
    # Put the completed sweep + MSS on row -2.
    rows[-3] = {"open": 101.0, "high": 101.2, "low": 100.5, "close": 100.9}
    rows[-2] = {"open": 100.9, "high": 102.0, "low": 100.0, "close": 101.8}
    rows[-1] = {"open": 101.8, "high": 102.1, "low": 101.7, "close": 101.9}
